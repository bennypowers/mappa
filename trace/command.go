...
// Package trace provides module graph tracing for ES module import analysis.
// It parses HTML and JavaScript files to extract import dependencies and
// generate minimal import maps.
package trace
